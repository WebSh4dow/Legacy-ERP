package com.developer.ERP.Legacy.API.infrastructure.service.Messages;
...
public class ClienteMessage {
	...
	public final static String MSG_CLIENTE_OUTROS_NAO_INFORMADO = "Para prosseguir deve ser informado o cadastro de outros.";
